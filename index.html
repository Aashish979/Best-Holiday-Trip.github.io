...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-expand-lg scrolling-navbar navbar-dark fixed-top">
            <div class="container">
                <a href="index.html" class="navbar-brand">
                    <i class=" fa fa-seedling"></i> Best Holiday Trip</a>
                <button class="navbar-toggler mr-2" data-toggle="collapse" data-target="#ui_navbar">
                    <span class="navbar-toggler-icon"></span>
                </button>

                <div class="collapse navbar-collapse" id="ui_navbar">
    ...
    <section id="places" class="p-3 mt-5">
        <div class="container">
            <div class="row text-center">
                <div class="col">
                    <h5 class="display-4">
                        <span class="text-info">Popular</span> Places
                    </h5>
            ...
            <div class="row ">
                <div class="col-md-4">
                    <div class="card mt-5 tour-image">
                        <img src="img/destinations/card_1.jpg" class="img-fluid" alt="">
                ...
                <div class="col-md-4">
                    <div class="card mt-5 tour-image">
                        <img src="img/destinations/card_2.jpg" class="img-fluid" alt="">
                        <div class="card-body text-center">
    ...
    <section id="gallery" class="p-4">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="img/gallery/gallery_1.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_2.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_3.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_4.jpg" class="img-fluid" alt="">
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-3">
                    <img src="img/gallery/gallery_5.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_6.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_7.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_8.jpg" class="img-fluid" alt="">
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-3">
                    <img src="img/gallery/gallery_9.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_10.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_11.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                    <img src="img/gallery/gallery_12.jpg" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
